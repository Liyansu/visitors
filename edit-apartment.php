<?php
    ...
    $query=mysqli_query($con,"UPDATE apartment SET apartment_status= '$apartmentstatus', building_number= '$buildingno' WHERE ID = '$eid';");
        ...
        <div class="box box-default">
          ...
          <?php
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php  echo $row['apartment_number'];?>">
                  </div>
                  <div class="form-group">
                    <label>Name</label>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control select3" name="buildingno" style="width: 100%;" required>
                      <option selected="<?php  echo $row['building_number'];?>"><?php  echo $row['building_number'];?></option>
            ...
            <div class="box-footer">
              <center><button type="submit" class="btn btn-primary rounded-0" name="submit">Update Apartment</button></center>
            </div>
          </div>
          </form>
