<?php
  ...
  if (strlen($_SESSION['avmsaid']==0)) {
    ...
    $query=mysqli_query($con,"INSERT into apartment(apartment_number,building_number,apartment_status,name) value ('$apartmentno','$buildingno','$apartmentstatus','$name')");
        ...
        <div class="box box-default">
          ...
          <!-- /.box-header -->
            ...
            <div class="box-footer">
              <center><button type="submit" class="btn btn-primary rounded-0" name="submit">Save Apartment</button></center>
            </div>
          </div>
          </form>
